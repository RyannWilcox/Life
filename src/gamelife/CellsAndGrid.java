...
public class CellsAndGrid implements RowColumnBounds, MaxMinBounds {
	...
	public void createPulsar() {
		cells[56][10].makeAlive();
		cells[56][11].makeAlive();
		cells[56][12].makeAlive();
		cells[56][13].makeAlive();
		cells[56][14].makeAlive();
		cells[60][10].makeAlive();
		cells[60][12].makeAlive();
		cells[60][11].makeAlive();
		cells[60][13].makeAlive();
		cells[60][14].makeAlive();
		cells[58][10].makeAlive();
		cells[58][14].makeAlive();
	}
	...
	public void createGliderGun() {
		cells[29][29].makeAlive();
		cells[29][30].makeAlive();
		cells[30][30].makeAlive();
		cells[30][29].makeAlive();
		cells[39][29].makeAlive();
		cells[39][30].makeAlive();
		cells[39][31].makeAlive();
		cells[40][28].makeAlive();
		cells[40][32].makeAlive();
		cells[41][33].makeAlive();
		cells[42][33].makeAlive();
		cells[41][27].makeAlive();
		cells[42][27].makeAlive();
		cells[44][32].makeAlive();
		cells[45][31].makeAlive();
		cells[45][30].makeAlive();
		cells[45][29].makeAlive();
		cells[46][30].makeAlive();
		cells[44][28].makeAlive();
		cells[43][30].makeAlive();
		cells[49][29].makeAlive();
		cells[49][28].makeAlive();
		cells[49][27].makeAlive();
		cells[50][29].makeAlive();
		cells[50][28].makeAlive();
		cells[50][27].makeAlive();
		cells[51][26].makeAlive();
		cells[51][30].makeAlive();
		cells[53][30].makeAlive();
		cells[53][31].makeAlive();
		cells[53][26].makeAlive();
		cells[53][25].makeAlive();
		cells[63][27].makeAlive();
		cells[63][28].makeAlive();
		cells[63][27].makeAlive();
		cells[64][28].makeAlive();
		cells[64][27].makeAlive();
	}

	public void createSpider() {
		cells[10][12].makeAlive();
		cells[11][13].makeAlive();
		cells[11][14].makeAlive();
		cells[10][14].makeAlive();
		cells[9][14].makeAlive();
		cells[22][66].makeAlive();
		cells[23][67].makeAlive();
		cells[23][68].makeAlive();
		cells[22][68].makeAlive();
		cells[21][68].makeAlive();
		cells[87][7].makeAlive();
		cells[88][8].makeAlive();
		cells[69][35].makeAlive();
		cells[89][6].makeAlive();
		cells[89][7].makeAlive();
		cells[69][36].makeAlive();
		cells[68][35].makeAlive();
		cells[67][35].makeAlive();
		cells[66][34].makeAlive();
		cells[65][34].makeAlive();
		cells[65][35].makeAlive();
		cells[65][36].makeAlive();
		cells[65][37].makeAlive();
		cells[64][37].makeAlive();
		cells[63][36].makeAlive();
		cells[68][38].makeAlive();
		cells[67][38].makeAlive();
		cells[67][39].makeAlive();
		cells[68][39].makeAlive();
		cells[65][39].makeAlive();
		cells[64][39].makeAlive();
		cells[64][40].makeAlive();
		cells[63][35].makeAlive();
		cells[63][34].makeAlive();
		cells[62][35].makeAlive();
		cells[61][35].makeAlive();
		cells[61][34].makeAlive();
		cells[60][33].makeAlive();
		cells[59][34].makeAlive();
		cells[58][34].makeAlive();
		cells[57][36].makeAlive();
		cells[57][37].makeAlive();
		cells[57][38].makeAlive();
		cells[55][36].makeAlive();
		cells[55][37].makeAlive();
		cells[55][38].makeAlive();
		cells[54][34].makeAlive();
		cells[53][34].makeAlive();
		cells[52][33].makeAlive();
		cells[51][34].makeAlive();
		cells[51][35].makeAlive();
		cells[50][35].makeAlive();
		cells[49][35].makeAlive();
		cells[49][34].makeAlive();
		cells[49][36].makeAlive();
		cells[48][37].makeAlive();
		cells[47][37].makeAlive();
		cells[47][36].makeAlive();
		cells[47][35].makeAlive();
		cells[47][34].makeAlive();
		cells[45][35].makeAlive();
		cells[44][35].makeAlive();
		cells[43][35].makeAlive();
		cells[43][36].makeAlive();
		cells[44][39].makeAlive();
		cells[44][38].makeAlive();
		cells[45][38].makeAlive();
		cells[45][39].makeAlive();
		cells[47][39].makeAlive();
		cells[48][39].makeAlive();
		cells[48][40].makeAlive();
		cells[46][34].makeAlive();
		cells[37][1].makeAlive();
		cells[38][2].makeAlive();
		cells[38][3].makeAlive();
		cells[37][3].makeAlive();
		cells[36][3].makeAlive();
	}

	public void createCustom() {
		cells[52][25].makeAlive();
		cells[54][25].makeAlive();
		cells[53][25].makeAlive();
		cells[55][25].makeAlive();
		cells[56][25].makeAlive();
		cells[57][25].makeAlive();
		cells[58][25].makeAlive();
		cells[55][24].makeAlive();
		cells[55][23].makeAlive();
		cells[55][22].makeAlive();
		cells[55][21].makeAlive();
		cells[55][27].makeAlive();
		cells[55][26].makeAlive();
		cells[55][28].makeAlive();
		cells[55][29].makeAlive();
		cells[55][30].makeAlive();
		cells[55][31].makeAlive();
		cells[54][31].makeAlive();
		cells[54][30].makeAlive();
		cells[53][29].makeAlive();
		cells[56][31].makeAlive();
		cells[56][30].makeAlive();
		cells[57][29].makeAlive();
	}
